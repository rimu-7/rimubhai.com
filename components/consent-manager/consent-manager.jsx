      ...
      <CookieBanner
        theme={{
          "banner.card": {
            noStyle: true,
            className: cn(
              "relative w-full max-w-(--banner-max-width) divide-y overflow-hidden rounded",
      ...
      <ConsentManagerDialog
        theme={{
          ...
          "widget.accordion.trigger-inner": {
            noStyle: true,
            className: cn(
              "flex flex-1 items-center rounded px-4 py-3 text-sm font-medium text-foreground **:[svg]:hidden",
