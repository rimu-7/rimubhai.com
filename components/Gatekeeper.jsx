...
const dialogues = [
  ...
  { quote: "The Joker: Why so serious?", source: "The Dark Knight", year: 2008, type: "Movie" },
  {
    quote:
  ...
  { quote: "The Terminator: I'll be back.", source: "The Terminator", year: 1984, type: "Movie" },
  {
  ...
  { quote: "Tony Stark: I love you 3000.", source: "Avengers: Endgame", year: 2019, type: "Movie" },
  {
  ...
  { quote: "Jesse Pinkman: Yeah, science!", source: "Breaking Bad", year: 2010, type: "TV Series" },
  { quote: "Travis Bickle: You talkin' to me?", source: "Taxi Driver", year: 1976, type: "Movie" },
  {
  ...
  { quote: "Joey Tribbiani: How you doin'?", source: "Friends", year: 1995, type: "TV Series" },
  {
  ...
  { quote: "Ron Burgundy: I love lamp.", source: "Anchorman", year: 2004, type: "Movie" },
  {
...
function getStoredStatus() {
  ...
  return sessionStorage.getItem("turnstile_verified") === "true" ? "success" : "idle";
}
